...
<head>
    ...
    <title>Daftar — Berkah-Link</title>
...
<body class="min-h-screen bg-stone-50 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-stone-500 text-sm mt-1">Buat akun baru</p>
        </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}"
                           ...
                           class="w-full border rounded-xl px-4 py-2.5 text-sm text-stone-800 placeholder-stone-300 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition {{ $errors->has('name') ? 'border-red-400 bg-red-50' : 'border-stone-200' }}">
                    @error('name')
                ...
                <div>
                    ...
                    <input id="password_confirmation" type="password" name="password_confirmation"
                           ...
                           class="w-full border rounded-xl px-4 py-2.5 text-sm text-stone-800 placeholder-stone-300 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition {{ $errors->has('password_confirmation') ? 'border-red-400 bg-red-50' : 'border-stone-200' }}">
                ...
                <p class="text-center text-sm text-stone-500">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-emerald-700 font-semibold hover:text-emerald-900 transition-colors">
                        Masuk di sini
                    </a>
                </p>
